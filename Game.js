  ...
  if(keyIsDown(LEFT_ARROW)&& player.index !== null){
   ...
   // if(dino.collide(player1)) {
    ...
    if(keyDown("space")&&player.index===1){
      var bullet1=createSprite(player10.x,player10.y,10,20);
     // player.update();
     bullet1.velocityY=-3;
    ...
    if(keyDown("space")&&player.index===2){
      var bullet2=createSprite(player20.x,player20.y,10,20);
     // player.update();
     bullet2.velocityY=-3;
    ...
    if(keyDown("space")&&player.index===3){
      var bullet3=createSprite(player30.x,player30.y,10,20);
     // player.update();
     bullet3.velocityY=-3;
    ...
    if(keyDown("space")&&player.index===4){
      var bullet4=createSprite(player40.x,player40.y,10,20);
     // player.update();
     bullet4.velocityY=-3;
